...
if __name__=="__main__":
    ...
    for i,eb in enumerate(ebs):
        ...
        for j,datafile in enumerate(datafiles):
            ...
            % (script_name,filepayh, dout,qout,uout,args.max_step,args.rate,args.maximum_rate,args.size_x,args.size_y,args.size_z,eb,\
                args.multidim_level,args.sz_interp,rlist,args.fix,args.autotuning,args.interp_block_size)
            if args.block_size>0:
